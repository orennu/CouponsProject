...
export class AlertsComponent implements OnInit, OnDestroy {
    ...
    cssClass(alert: Alert) {
      ...
      const alertTypeClass = {
          [AlertType.Success]: 'alert-success text-center',
          [AlertType.Error]: 'alert-danger text-center',
          [AlertType.Info]: 'alert-info text-center',
          [AlertType.Warning]: 'alert-warning text-center'
      }
